.class public final Lcom/fonbet/restrictions/api/fon/domain/data/RestrictionKt;
...
# direct methods
.method public static final synthetic hasRestriction(Ljava/util/List;Lcom/fonbet/restrictions/api/fon/domain/data/Restriction$Reason;Z)Z
    .locals 7
    ...
    const-class v6, Lcom/fonbet/restrictions/api/fon/domain/data/Restriction;
    ...
    const-class v4, Lcom/fonbet/restrictions/api/fon/domain/data/Restriction;
...
.method public static synthetic hasRestriction$default(Ljava/util/List;Lcom/fonbet/restrictions/api/fon/domain/data/Restriction$Reason;ZILjava/lang/Object;)Z
    .locals 5
    ...
    check-cast p3, Lcom/fonbet/restrictions/api/fon/domain/data/Restriction;
    ...
    instance-of v1, p3, Lcom/fonbet/restrictions/api/fon/domain/data/Restriction;

    if-eqz v1, :cond_8

    if-eqz p1, :cond_4

    invoke-virtual {p3}, Lcom/fonbet/restrictions/api/fon/domain/data/Restriction;->getReason()Lcom/fonbet/restrictions/api/fon/domain/data/Restriction$Reason;
    ...
    .line 16
    :cond_4
    const-class v1, Lcom/fonbet/restrictions/api/fon/domain/data/Restriction$Withdrawal;
    ...
    const-class v1, Lcom/fonbet/restrictions/api/fon/domain/data/Restriction$Deposit;
    ...
    const-class v2, Lcom/fonbet/restrictions/api/fon/domain/data/Restriction;
    ...
    .line 18
    invoke-virtual {p3}, Lcom/fonbet/restrictions/api/fon/domain/data/Restriction;->getOneTimeLimit()Ljava/math/BigDecimal;
    ...
    invoke-virtual {p3}, Lcom/fonbet/restrictions/api/fon/domain/data/Restriction;->getTotalLimit()Ljava/math/BigDecimal;
