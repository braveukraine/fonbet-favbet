...
.method public final a()Lj/d;
    ...
    invoke-virtual {v0, v1}, Lj/d;->o(Landroidx/appcompat/view/menu/e;)V

    .line 12
    iget-object v1, p0, Landroidx/appcompat/view/menu/h;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Lj/d;->x(Landroid/widget/PopupWindow$OnDismissListener;)V

    .line 13
    iget-object v1, p0, Landroidx/appcompat/view/menu/h;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Lj/d;->s(Landroid/view/View;)V

    .line 14
    iget-object v1, p0, Landroidx/appcompat/view/menu/h;->i:Landroidx/appcompat/view/menu/i$a;

    invoke-interface {v0, v1}, Landroidx/appcompat/view/menu/i;->i(Landroidx/appcompat/view/menu/i$a;)V
    ...
    invoke-virtual {v0, v1}, Lj/d;->v(I)V
...
.method public g(Z)V
    ...
    .line 3
    invoke-virtual {v0, p1}, Lj/d;->u(Z)V
...
.method public final l(IIZZ)V
    ...
    .line 2
    invoke-virtual {v0, p4}, Lj/d;->y(Z)V
    ...
    .line 4
    invoke-static {p4}, Lm0/a0;->E(Landroid/view/View;)I

    move-result p4

    .line 5
    invoke-static {p3, p4}, Lm0/f;->b(II)I
    ...
    .line 7
    :cond_0
    invoke-virtual {v0, p1}, Lj/d;->w(I)V

    .line 8
    invoke-virtual {v0, p2}, Lj/d;->z(I)V
    ...
    .line 11
    invoke-virtual {v0, p4}, Lj/d;->t(Landroid/graphics/Rect;)V

    .line 12
    :cond_1
    invoke-interface {v0}, Lj/f;->c()V
