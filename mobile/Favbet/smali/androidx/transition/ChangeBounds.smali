...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/transition/ChangeBounds;->X:Lo1/e;
...
.method public g(Lo1/i;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/transition/ChangeBounds;->g0(Lo1/i;)V
...
.method public final g0(Lo1/i;)V
    ...
    invoke-static {v0}, Lm0/a0;->w(Landroid/view/View;)Landroid/graphics/Rect;
...
.method public final h0(Landroid/view/View;Landroid/view/View;)Z
    ...
    .line 2
    invoke-virtual {p0, p1, v1}, Landroidx/transition/Transition;->v(Landroid/view/View;Z)Lo1/i;
    ...
    .line 3
    :cond_1
    iget-object p1, v0, Lo1/i;->b:Landroid/view/View;
...
.method public p(Landroid/view/ViewGroup;Lo1/i;Lo1/i;)Landroid/animation/Animator;
    ...
    .line 1
    :cond_0
    iget-object v3, v0, Lo1/i;->a:Ljava/util/Map;

    .line 2
    iget-object v4, v1, Lo1/i;->a:Ljava/util/Map;
    ...
    .line 5
    :cond_1
    iget-object v9, v1, Lo1/i;->b:Landroid/view/View;

    .line 6
    invoke-virtual {v8, v3, v4}, Landroidx/transition/ChangeBounds;->h0(Landroid/view/View;Landroid/view/View;)Z
    ...
    .line 8
    iget-object v6, v1, Lo1/i;->a:Ljava/util/Map;
    ...
    .line 17
    iget-object v0, v0, Lo1/i;->a:Ljava/util/Map;
    ...
    .line 18
    iget-object v1, v1, Lo1/i;->a:Ljava/util/Map;
    ...
    .line 21
    invoke-static {v9, v6, v11, v13, v3}, Lo1/s;->f(Landroid/view/View;IIII)V
    ...
    invoke-static {v9, v1, v0}, Lo1/a;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    .line 27
    invoke-static {v1, v4, v2}, Lo1/a;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v1, v4, v3}, Lo1/a;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    .line 39
    invoke-static {v9, v6, v11, v1, v3}, Lo1/s;->f(Landroid/view/View;IIII)V
    ...
    invoke-static {v9, v3, v1}, Lo1/a;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    .line 45
    invoke-static {v9, v1}, Lm0/a0;->x0(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 46
    sget-object v4, Landroidx/transition/ChangeBounds;->X:Lo1/e;
    ...
    .line 48
    :goto_8
    invoke-static {v11, v2}, Lo1/h;->c(Landroid/animation/Animator;Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    .line 51
    invoke-static {v1, v2}, Lo1/n;->c(Landroid/view/ViewGroup;Z)V
    ...
    .line 54
    :cond_17
    iget-object v2, v0, Lo1/i;->a:Ljava/util/Map;
    ...
    .line 56
    iget-object v5, v1, Lo1/i;->a:Ljava/util/Map;
    ...
    .line 63
    invoke-static {v9}, Lo1/s;->c(Landroid/view/View;)F
    ...
    .line 64
    invoke-static {v9, v4}, Lo1/s;->g(Landroid/view/View;F)V

    .line 65
    invoke-static/range {p1 .. p1}, Lo1/s;->b(Landroid/view/View;)Lo1/r;

    move-result-object v4

    invoke-interface {v4, v6}, Lo1/r;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v1, v0}, Lo1/c;->a(Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/PropertyValuesHolder;
