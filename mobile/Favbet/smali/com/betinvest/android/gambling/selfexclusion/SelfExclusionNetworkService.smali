.class public Lcom/betinvest/android/gambling/selfexclusion/SelfExclusionNetworkService;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/betinvest/android/gambling/selfexclusion/dto/SelfExclusionParams;",
...
# static fields
.field private static final GET_REQUEST:Ljava/lang/String; = "{\"query\":{\"exclusion_limit\":{}}}"

.field private static final SELF_EXCLUSION_KEY:Ljava/lang/String; = "exclusion_limit"
...
.method public getNetworkCommand()Lcom/betinvest/android/core/network/NetworkCommand;
    ...
    .line 1
    sget-object v0, Lcom/betinvest/android/core/network/NetworkCommand;->SELF_EXCLUSION:Lcom/betinvest/android/core/network/NetworkCommand;
...
.method public handleResponse(Ljava/lang/String;Lcom/fasterxml/jackson/databind/JsonNode;Ljava/lang/Object;)V
    ...
    const-string p1, "exclusion_limit"
    ...
    const-class p3, Lcom/betinvest/android/gambling/selfexclusion/dto/SelfExclusionResponse;
...
.method public sendCommand(Lcom/betinvest/android/gambling/selfexclusion/dto/SelfExclusionParams;)V
    .locals 1

    .line 2
    invoke-virtual {p1}, Lcom/betinvest/android/gambling/selfexclusion/dto/SelfExclusionParams;->isOnlyGet()Z

    move-result v0

    if-eqz v0, :cond_0

    const-string p1, "{\"query\":{\"exclusion_limit\":{}}}"
    ...
    .line 4
    :cond_0
    invoke-virtual {p1}, Lcom/betinvest/android/gambling/selfexclusion/dto/SelfExclusionParams;->toString()Ljava/lang/String;
...
.method public bridge synthetic sendCommand(Ljava/lang/Object;)V
    ...
    .line 1
    check-cast p1, Lcom/betinvest/android/gambling/selfexclusion/dto/SelfExclusionParams;

    invoke-virtual {p0, p1}, Lcom/betinvest/android/gambling/selfexclusion/SelfExclusionNetworkService;->sendCommand(Lcom/betinvest/android/gambling/selfexclusion/dto/SelfExclusionParams;)V
