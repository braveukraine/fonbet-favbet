.class public Lcom/betinvest/android/gambling/limits/deposit/network/DepositLimitNetworkService;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/betinvest/android/gambling/limits/deposit/network/dto/DepositLimitParams;",
...
# static fields
.field private static final DEPOSIT_LIMIT_KEY:Ljava/lang/String; = "deposit_limit"

.field private static final GET_REQUEST:Ljava/lang/String; = "{\"query\":{\"deposit_limit\":{}}}"
...
.method public getNetworkCommand()Lcom/betinvest/android/core/network/NetworkCommand;
    ...
    .line 1
    sget-object v0, Lcom/betinvest/android/core/network/NetworkCommand;->DEPOSIT_LIMIT:Lcom/betinvest/android/core/network/NetworkCommand;
...
.method public handleResponse(Ljava/lang/String;Lcom/fasterxml/jackson/databind/JsonNode;Ljava/lang/Object;)V
    ...
    const-class p3, Lcom/betinvest/android/gambling/limits/deposit/network/dto/DepositLimitResponse;
...
.method public sendCommand(Lcom/betinvest/android/gambling/limits/deposit/network/dto/DepositLimitParams;)V
    .locals 1

    .line 2
    invoke-virtual {p1}, Lcom/betinvest/android/gambling/limits/deposit/network/dto/DepositLimitParams;->isOnlyGet()Z

    move-result v0

    if-eqz v0, :cond_0

    const-string p1, "{\"query\":{\"deposit_limit\":{}}}"
    ...
    .line 4
    :cond_0
    invoke-virtual {p1}, Lcom/betinvest/android/gambling/limits/deposit/network/dto/DepositLimitParams;->toString()Ljava/lang/String;
...
.method public bridge synthetic sendCommand(Ljava/lang/Object;)V
    ...
    .line 1
    check-cast p1, Lcom/betinvest/android/gambling/limits/deposit/network/dto/DepositLimitParams;

    invoke-virtual {p0, p1}, Lcom/betinvest/android/gambling/limits/deposit/network/DepositLimitNetworkService;->sendCommand(Lcom/betinvest/android/gambling/limits/deposit/network/dto/DepositLimitParams;)V
