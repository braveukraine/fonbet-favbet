...
# direct methods
.method public constructor <init>(Lz/i$e;)V
    .locals 13
    ...
    iput-object v0, p0, Lz/j;->f:Ljava/util/List;
    ...
    iput-object v0, p0, Lz/j;->g:Landroid/os/Bundle;

    .line 4
    iput-object p1, p0, Lz/j;->c:Lz/i$e;

    .line 5
    iget-object v0, p1, Lz/i$e;->a:Landroid/content/Context;

    iput-object v0, p0, Lz/j;->a:Landroid/content/Context;
    ...
    iget-object v3, p1, Lz/i$e;->a:Landroid/content/Context;

    iget-object v4, p1, Lz/i$e;->K:Ljava/lang/String;

    invoke-direct {v2, v3, v4}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v2, p0, Lz/j;->b:Landroid/app/Notification$Builder;
    ...
    .line 9
    :goto_0
    iget-object v2, p1, Lz/i$e;->S:Landroid/app/Notification;

    .line 10
    iget-object v3, p0, Lz/j;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v5, p1, Lz/i$e;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Lz/i$e;->e:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Lz/i$e;->f:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Lz/i$e;->k:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Lz/i$e;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lz/i$e;->h:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lz/i$e;->j:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Lz/i$e;->t:I

    iget v9, p1, Lz/i$e;->u:I

    iget-boolean v10, p1, Lz/i$e;->v:Z
    ...
    .line 29
    iget-object v4, p0, Lz/j;->b:Landroid/app/Notification$Builder;
    ...
    .line 30
    iget-object v0, p0, Lz/j;->b:Landroid/app/Notification$Builder;

    iget-object v8, p1, Lz/i$e;->q:Ljava/lang/CharSequence;
    ...
    check-cast v8, Lz/i$a;

    .line 34
    invoke-virtual {p0, v8}, Lz/j;->b(Lz/i$a;)V

    goto :goto_5

    .line 35
    :cond_6
    iget-object v0, p1, Lz/i$e;->D:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    .line 36
    iget-object v8, p0, Lz/j;->g:Landroid/os/Bundle;
    ...
    .line 38
    iget-boolean v0, p1, Lz/i$e;->z:Z

    if-eqz v0, :cond_8

    .line 39
    iget-object v0, p0, Lz/j;->g:Landroid/os/Bundle;
    ...
    .line 40
    :cond_8
    iget-object v0, p1, Lz/i$e;->w:Ljava/lang/String;
    ...
    :cond_a
    :goto_6
    iget-object v0, p1, Lz/i$e;->y:Ljava/lang/String;
    ...
    .line 47
    :cond_b
    iget-object v0, p1, Lz/i$e;->H:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lz/j;->d:Landroid/widget/RemoteViews;

    .line 48
    iget-object v0, p1, Lz/i$e;->I:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lz/j;->e:Landroid/widget/RemoteViews;
    ...
    .line 50
    iget-object v8, p0, Lz/j;->b:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, Lz/i$e;->n:Z
    ...
    .line 51
    iget-object v8, p1, Lz/i$e;->c:Ljava/util/ArrayList;

    invoke-static {v8}, Lz/j;->g(Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    iget-object v9, p1, Lz/i$e;->V:Ljava/util/ArrayList;

    invoke-static {v8, v9}, Lz/j;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 53
    iget-object v9, p0, Lz/j;->g:Landroid/os/Bundle;
    ...
    iget-object v8, p1, Lz/i$e;->G:Landroid/app/Notification;
    ...
    .line 66
    iget-object v0, p1, Lz/i$e;->c:Ljava/util/ArrayList;

    invoke-static {v0}, Lz/j;->g(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iget-object v3, p1, Lz/i$e;->V:Ljava/util/ArrayList;

    invoke-static {v0, v3}, Lz/j;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 67
    :cond_10
    iget-object v0, p1, Lz/i$e;->V:Ljava/util/ArrayList;
    ...
    .line 71
    :cond_11
    iget-object v0, p1, Lz/i$e;->J:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lz/j;->i:Landroid/widget/RemoteViews;

    .line 72
    iget-object v0, p1, Lz/i$e;->d:Ljava/util/ArrayList;
    ...
    .line 73
    invoke-virtual {p1}, Lz/i$e;->c()Landroid/os/Bundle;
    ...
    .line 77
    :goto_9
    iget-object v11, p1, Lz/i$e;->d:Ljava/util/ArrayList;
    ...
    iget-object v12, p1, Lz/i$e;->d:Ljava/util/ArrayList;
    ...
    check-cast v12, Lz/i$a;

    .line 80
    invoke-static {v12}, Lz/k;->b(Lz/i$a;)Landroid/os/Bundle;
    ...
    .line 87
    iget-object v3, p1, Lz/i$e;->U:Landroid/graphics/drawable/Icon;
    ...
    .line 91
    iget-object v3, p1, Lz/i$e;->H:Landroid/widget/RemoteViews;
    ...
    .line 93
    :cond_16
    iget-object v3, p1, Lz/i$e;->I:Landroid/widget/RemoteViews;
    ...
    .line 95
    :cond_17
    iget-object v3, p1, Lz/i$e;->J:Landroid/widget/RemoteViews;
    ...
    iget-object v9, p1, Lz/i$e;->M:Ljava/lang/String;
    ...
    .line 110
    iget-object v7, p0, Lz/j;->b:Landroid/app/Notification$Builder;

    invoke-virtual {v4}, Lz/m;->h()Landroid/app/Person;
    ...
    iget-object v7, p1, Lz/i$e;->R:Lz/i$d;

    .line 114
    invoke-static {v7}, Lz/i$d;->a(Lz/i$d;)Landroid/app/Notification$BubbleMetadata;
    ...
    .line 119
    :cond_1d
    iget-boolean p1, p1, Lz/i$e;->T:Z

    if-eqz p1, :cond_20

    .line 120
    iget-object p1, p0, Lz/j;->c:Lz/i$e;

    iget-boolean p1, p1, Lz/i$e;->x:Z
    ...
    .line 123
    :goto_b
    iget-object p1, p0, Lz/j;->b:Landroid/app/Notification$Builder;
    ...
    .line 127
    iget-object v2, p0, Lz/j;->b:Landroid/app/Notification$Builder;
    ...
    iget-object p1, p1, Lz/i$e;->w:Ljava/lang/String;
...
.method public static g(Ljava/util/List;)Ljava/util/List;
    ...
    .line 3
    invoke-virtual {v1}, Lz/m;->g()Ljava/lang/String;
...
.method public final b(Lz/i$a;)V
    .locals 5
    ...
    .line 2
    invoke-virtual {p1}, Lz/i$a;->e()Landroidx/core/graphics/drawable/IconCompat;
    ...
    .line 5
    :goto_0
    invoke-virtual {p1}, Lz/i$a;->i()Ljava/lang/CharSequence;

    move-result-object v2

    .line 6
    invoke-virtual {p1}, Lz/i$a;->a()Landroid/app/PendingIntent;
    ...
    .line 11
    :goto_2
    invoke-virtual {p1}, Lz/i$a;->f()[Lz/n;
    ...
    .line 13
    invoke-static {v1}, Lz/n;->b([Lz/n;)[Landroid/app/RemoteInput;
    ...
    .line 15
    :cond_3
    invoke-virtual {p1}, Lz/i$a;->d()Landroid/os/Bundle;
    ...
    .line 30
    iget-object v0, p0, Lz/j;->f:Ljava/util/List;

    iget-object v1, p0, Lz/j;->b:Landroid/app/Notification$Builder;

    .line 31
    invoke-static {v1, p1}, Lz/k;->f(Landroid/app/Notification$Builder;Lz/i$a;)Landroid/os/Bundle;
...
.method public c()Landroid/app/Notification;
    ...
    .line 1
    iget-object v0, p0, Lz/j;->c:Lz/i$e;

    iget-object v0, v0, Lz/i$e;->p:Lz/i$f;

    if-eqz v0, :cond_0

    .line 2
    invoke-virtual {v0, p0}, Lz/i$f;->b(Lz/h;)V

    :cond_0
    if-eqz v0, :cond_1

    .line 3
    invoke-virtual {v0, p0}, Lz/i$f;->e(Lz/h;)Landroid/widget/RemoteViews;
    ...
    .line 4
    :goto_0
    invoke-virtual {p0}, Lz/j;->d()Landroid/app/Notification;
    ...
    .line 6
    :cond_2
    iget-object v1, p0, Lz/j;->c:Lz/i$e;

    iget-object v1, v1, Lz/i$e;->H:Landroid/widget/RemoteViews;
    ...
    .line 9
    invoke-virtual {v0, p0}, Lz/i$f;->d(Lz/h;)Landroid/widget/RemoteViews;
    ...
    .line 11
    iget-object v4, p0, Lz/j;->c:Lz/i$e;

    iget-object v4, v4, Lz/i$e;->p:Lz/i$f;

    .line 12
    invoke-virtual {v4, p0}, Lz/i$f;->f(Lz/h;)Landroid/widget/RemoteViews;
    ...
    .line 14
    invoke-static {v2}, Lz/i;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    .line 15
    invoke-virtual {v0, v1}, Lz/i$f;->a(Landroid/os/Bundle;)V
...
.method public d()Landroid/app/Notification;
    ...
    .line 6
    invoke-virtual {p0, v0}, Lz/j;->h(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, Lz/j;->g:Landroid/os/Bundle;
    ...
    .line 11
    iget-object v1, p0, Lz/j;->d:Landroid/widget/RemoteViews;
    ...
    .line 13
    :cond_4
    iget-object v1, p0, Lz/j;->e:Landroid/widget/RemoteViews;
    ...
    .line 15
    :cond_5
    iget-object v1, p0, Lz/j;->i:Landroid/widget/RemoteViews;
    ...
    .line 34
    invoke-static {v0}, Lz/k;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    .line 43
    invoke-static {v0}, Lz/i;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    iget-object v4, p0, Lz/j;->g:Landroid/os/Bundle;
    ...
    .line 49
    iget-object v1, p0, Lz/j;->f:Ljava/util/List;

    .line 50
    invoke-static {v1}, Lz/k;->a(Ljava/util/List;)Landroid/util/SparseArray;
...
.method public f()Landroid/content/Context;
    ...
    .line 1
    iget-object v0, p0, Lz/j;->a:Landroid/content/Context;
