...
.method public constructor <init>(Luc/e;Lrb/a;Ljava/util/concurrent/Executor;Laa/f;Ljava/util/Random;Lod/e;Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;Lcom/google/firebase/remoteconfig/internal/c;Ljava/util/Map;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lcom/google/firebase/remoteconfig/internal/b;->a:Luc/e;

    .line 3
    iput-object p2, p0, Lcom/google/firebase/remoteconfig/internal/b;->b:Lrb/a;

    .line 4
    iput-object p3, p0, Lcom/google/firebase/remoteconfig/internal/b;->c:Ljava/util/concurrent/Executor;

    .line 5
    iput-object p4, p0, Lcom/google/firebase/remoteconfig/internal/b;->d:Laa/f;

    .line 6
    iput-object p5, p0, Lcom/google/firebase/remoteconfig/internal/b;->e:Ljava/util/Random;

    .line 7
    iput-object p6, p0, Lcom/google/firebase/remoteconfig/internal/b;->f:Lod/e;
...
.method public static synthetic m(Lcom/google/firebase/remoteconfig/internal/b;JLsa/g;)Lsa/g;
    .locals 0

    .line 1
    invoke-virtual {p0, p3, p1, p2}, Lcom/google/firebase/remoteconfig/internal/b;->h(Lsa/g;J)Lsa/g;
...
.method public static synthetic n(Lcom/google/firebase/remoteconfig/internal/b$a;Lcom/google/firebase/remoteconfig/internal/a;)Lsa/g;
    .locals 0
...
.method public static synthetic o(Lcom/google/firebase/remoteconfig/internal/b;Lsa/g;Lsa/g;Ljava/util/Date;Lsa/g;)Lsa/g;
    .locals 0
    ...
    .line 4
    invoke-static {p0}, Lcom/google/android/gms/tasks/a;->d(Ljava/lang/Exception;)Lsa/g;
    ...
    .line 7
    invoke-virtual {p2}, Lsa/g;->j()Ljava/lang/Exception;
    ...
    invoke-virtual {p2}, Lcom/google/firebase/installations/d;->b()Ljava/lang/String;

    move-result-object p2

    .line 11
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/firebase/remoteconfig/internal/b;->g(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;)Lsa/g;
...
.method public static synthetic p(Lcom/google/firebase/remoteconfig/internal/b;Ljava/util/Date;Lsa/g;)Lsa/g;
    .locals 0

    .line 1
    invoke-virtual {p0, p2, p1}, Lcom/google/firebase/remoteconfig/internal/b;->t(Lsa/g;Ljava/util/Date;)V
...
.method public d()Lsa/g;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/google/firebase/remoteconfig/internal/b;->e(J)Lsa/g;
...
.method public e(J)Lsa/g;
    ...
    .line 1
    iget-object v0, p0, Lcom/google/firebase/remoteconfig/internal/b;->f:Lod/e;
    ...
    invoke-static {p0, p1, p2}, Lod/f;->b(Lcom/google/firebase/remoteconfig/internal/b;J)Lsa/a;

    move-result-object p1

    .line 3
    invoke-virtual {v0, v1, p1}, Lsa/g;->h(Ljava/util/concurrent/Executor;Lsa/a;)Lsa/g;
...
.method public final f(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/b$a;
    .locals 9
    ...
    .line 3
    invoke-virtual {p0}, Lcom/google/firebase/remoteconfig/internal/b;->k()Ljava/util/Map;
    ...
    invoke-virtual {p0, p2, p3}, Lcom/google/firebase/remoteconfig/internal/b;->r(ILjava/util/Date;)Lcom/google/firebase/remoteconfig/internal/c$a;
    ...
    invoke-virtual {p0, p2, p3}, Lcom/google/firebase/remoteconfig/internal/b;->q(Lcom/google/firebase/remoteconfig/internal/c$a;I)Z
    ...
    .line 13
    :cond_1
    invoke-virtual {p0, p1}, Lcom/google/firebase/remoteconfig/internal/b;->b(Lcom/google/firebase/remoteconfig/FirebaseRemoteConfigServerException;)Lcom/google/firebase/remoteconfig/FirebaseRemoteConfigServerException;
...
.method public final g(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;)Lsa/g;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/firebase/remoteconfig/internal/b;->f(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/b$a;
    ...
    .line 4
    :cond_0
    iget-object p2, p0, Lcom/google/firebase/remoteconfig/internal/b;->f:Lod/e;
    ...
    invoke-virtual {p2, p3}, Lod/e;->i(Lcom/google/firebase/remoteconfig/internal/a;)Lsa/g;

    move-result-object p2

    iget-object p3, p0, Lcom/google/firebase/remoteconfig/internal/b;->c:Ljava/util/concurrent/Executor;

    invoke-static {p1}, Lod/i;->b(Lcom/google/firebase/remoteconfig/internal/b$a;)Lsa/f;

    move-result-object p1

    .line 6
    invoke-virtual {p2, p3, p1}, Lsa/g;->p(Ljava/util/concurrent/Executor;Lsa/f;)Lsa/g;
...
.method public final h(Lsa/g;J)Lsa/g;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lcom/google/firebase/remoteconfig/internal/b;->d:Laa/f;
    ...
    .line 3
    invoke-virtual {p0, p2, p3, v0}, Lcom/google/firebase/remoteconfig/internal/b;->a(JLjava/util/Date;)Z
    ...
    .line 5
    :cond_0
    invoke-virtual {p0, v0}, Lcom/google/firebase/remoteconfig/internal/b;->i(Ljava/util/Date;)Ljava/util/Date;
    ...
    invoke-virtual {p0, v1, v2}, Lcom/google/firebase/remoteconfig/internal/b;->c(J)Ljava/lang/String;
    ...
    .line 9
    invoke-static {p2}, Lcom/google/android/gms/tasks/a;->d(Ljava/lang/Exception;)Lsa/g;
    ...
    .line 10
    :cond_1
    iget-object p1, p0, Lcom/google/firebase/remoteconfig/internal/b;->a:Luc/e;

    invoke-interface {p1}, Luc/e;->a()Lsa/g;

    move-result-object p1

    .line 11
    iget-object p2, p0, Lcom/google/firebase/remoteconfig/internal/b;->a:Luc/e;

    const/4 p3, 0x0

    .line 12
    invoke-interface {p2, p3}, Luc/e;->b(Z)Lsa/g;

    move-result-object p2

    const/4 v1, 0x2

    new-array v1, v1, [Lsa/g;
    ...
    .line 13
    invoke-static {v1}, Lcom/google/android/gms/tasks/a;->i([Lsa/g;)Lsa/g;

    move-result-object p3

    iget-object v1, p0, Lcom/google/firebase/remoteconfig/internal/b;->c:Ljava/util/concurrent/Executor;

    invoke-static {p0, p1, p2, v0}, Lod/g;->b(Lcom/google/firebase/remoteconfig/internal/b;Lsa/g;Lsa/g;Ljava/util/Date;)Lsa/a;

    move-result-object p1

    .line 14
    invoke-virtual {p3, v1, p1}, Lsa/g;->h(Ljava/util/concurrent/Executor;Lsa/a;)Lsa/g;
    ...
    invoke-static {p0, v0}, Lod/h;->b(Lcom/google/firebase/remoteconfig/internal/b;Ljava/util/Date;)Lsa/a;

    move-result-object p3

    invoke-virtual {p1, p2, p3}, Lsa/g;->h(Ljava/util/concurrent/Executor;Lsa/a;)Lsa/g;
...
.method public final k()Ljava/util/Map;
    ...
    .line 2
    iget-object v1, p0, Lcom/google/firebase/remoteconfig/internal/b;->b:Lrb/a;
    ...
    .line 3
    invoke-interface {v1, v2}, Lrb/a;->a(Z)Ljava/util/Map;
...
.method public final q(Lcom/google/firebase/remoteconfig/internal/c$a;I)Z
    .locals 1
...
.method public final r(ILjava/util/Date;)Lcom/google/firebase/remoteconfig/internal/c$a;
    .locals 0

    .line 1
    invoke-virtual {p0, p1}, Lcom/google/firebase/remoteconfig/internal/b;->l(I)Z
    ...
    .line 2
    invoke-virtual {p0, p2}, Lcom/google/firebase/remoteconfig/internal/b;->s(Ljava/util/Date;)V
...
.method public final s(Ljava/util/Date;)V
    ...
    .line 2
    invoke-virtual {p0, v0}, Lcom/google/firebase/remoteconfig/internal/b;->j(I)J
...
.method public final t(Lsa/g;Ljava/util/Date;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
