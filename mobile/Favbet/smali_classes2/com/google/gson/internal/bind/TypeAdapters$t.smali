...
.method public bridge synthetic b(Lvd/a;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/google/gson/internal/bind/TypeAdapters$t;->e(Lvd/a;)Lpd/i;
...
.method public bridge synthetic d(Lcom/google/gson/stream/b;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/google/gson/internal/bind/TypeAdapters$t;->f(Lcom/google/gson/stream/b;Lpd/i;)V

    return-void
.end method

.method public e(Lvd/a;)Lpd/i;
    .locals 3
    ...
    invoke-virtual {v0, v1, v2}, Lpd/k;->m(Ljava/lang/String;Lpd/i;)V
    ...
    invoke-virtual {v0, v1}, Lpd/f;->m(Lpd/i;)V
    ...
    invoke-direct {v1, p1}, Lrd/e;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v1}, Lpd/m;-><init>(Ljava/lang/Number;)V
...
.method public f(Lcom/google/gson/stream/b;Lpd/i;)V
    .locals 2

    if-eqz p2, :cond_8

    .line 1
    invoke-virtual {p2}, Lpd/i;->j()Z
    ...
    .line 3
    invoke-virtual {p2}, Lpd/i;->h()Lpd/m;

    move-result-object p2

    .line 4
    invoke-virtual {p2}, Lpd/m;->w()Z
    ...
    .line 5
    invoke-virtual {p2}, Lpd/m;->r()Ljava/lang/Number;
    ...
    .line 7
    invoke-virtual {p2}, Lpd/m;->m()Z

    move-result p2

    invoke-virtual {p1, p2}, Lcom/google/gson/stream/b;->V(Z)Lcom/google/gson/stream/b;

    goto/16 :goto_3

    .line 8
    :cond_2
    invoke-virtual {p2}, Lpd/m;->s()Ljava/lang/String;
    ...
    .line 11
    invoke-virtual {p2}, Lpd/i;->a()Lpd/f;

    move-result-object p2

    invoke-virtual {p2}, Lpd/f;->iterator()Ljava/util/Iterator;
    ...
    .line 12
    invoke-virtual {p0, p1, v0}, Lcom/google/gson/internal/bind/TypeAdapters$t;->f(Lcom/google/gson/stream/b;Lpd/i;)V
    ...
    .line 16
    invoke-virtual {p2}, Lpd/i;->b()Lpd/k;

    move-result-object p2

    invoke-virtual {p2}, Lpd/k;->p()Ljava/util/Set;
