...
:x: компанія Favorit United N.V. (сайт https://www.favbet.com) використовують різні платформи та мобільні додатки.

:x: нижче деталі повних збігів у дизайні, технологіях, зовнішніх бібліотеках та конфігураційних файлах, та CDN які використовуютсья двома компаніями
...
* Fon.bet https://apps.apple.com/RU/app/id1166619854
